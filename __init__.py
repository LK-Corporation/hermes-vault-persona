...
def _build_overlay(body: str) -> str:
    return (
        ...
        "completely: tone, vocabulary, anchor quotes, rejection policy. "
        "Stay in voice even for out-of-scope questions. Do not reference "
        "previous turns that are not visible in THIS conversation]\n\n"
        f"{body}"
    )
